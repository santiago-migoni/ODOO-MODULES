...
// Integración de componentes de web_responsive
import { AppsMenu } from "@dipl_ui_interface/components/apps_menu/apps_menu.esm";
import { AppMenuItem } from "@dipl_ui_interface/components/apps_menu_item/apps_menu_item.esm";
import { AppsMenuSearchBar } from "@dipl_ui_interface/components/menu_searchbar/searchbar.esm";

export class EnterpriseNavBar extends NavBar {
    static template = "dipl_ui_interface.EnterpriseNavBar";
    static components = { ...NavBar.components, AppsMenu, AppMenuItem, AppsMenuSearchBar };

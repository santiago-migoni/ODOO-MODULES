...
3. Abrir/cerrar home menu y verificar que la accion cliente `dipl_web_theme.home_menu` renderiza el menu y que el boton de navbar permite volver a la vista previa.

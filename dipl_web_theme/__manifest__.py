...

{
    ...
    'assets': {
        'web._assets_primary_variables': [
            ('after', 'web/static/src/scss/primary_variables.scss', 'dipl_web_theme/static/src/**/*.variables.scss'),
            ('before', 'web/static/src/scss/primary_variables.scss', 'dipl_web_theme/static/src/scss/primary_variables.scss'),
        ],
        'web._assets_secondary_variables': [
            ('before', 'web/static/src/scss/secondary_variables.scss', 'dipl_web_theme/static/src/scss/secondary_variables.scss'),
        ],
        'web._assets_backend_helpers': [
            ('before', 'web/static/src/scss/bootstrap_overridden.scss', 'dipl_web_theme/static/src/scss/bootstrap_overridden.scss'),
        ],
        'web.assets_frontend': [
        ...
        'web.assets_backend': [
            ...
            ('after', 'web/static/src/views/list/list_renderer.xml', 'dipl_web_theme/static/src/views/list/list_renderer_desktop.xml'),
        ...
        'web.assets_backend_lazy_dark': [
            ...
            # web._assets_backend_helpers
            ('before', 'dipl_web_theme/static/src/scss/bootstrap_overridden.scss', 'dipl_web_theme/static/src/scss/bootstrap_overridden.dark.scss'),
            ('after', 'web/static/lib/bootstrap/scss/_functions.scss', 'dipl_web_theme/static/src/scss/bs_functions_overridden.dark.scss'),
        ],
        # ========= Dark Mode =========
        "web.dark_mode_variables": [
            # web._assets_primary_variables
            ('before', 'dipl_web_theme/static/src/scss/primary_variables.scss', 'dipl_web_theme/static/src/scss/primary_variables.dark.scss'),
            ('before', 'dipl_web_theme/static/src/**/*.variables.scss', 'dipl_web_theme/static/src/**/*.variables.dark.scss'),
            # web._assets_secondary_variables
            ('before', 'dipl_web_theme/static/src/scss/secondary_variables.scss', 'dipl_web_theme/static/src/scss/secondary_variables.dark.scss'),
        ],
        "web.assets_web_dark": [
            ('include', 'web.dark_mode_variables'),
            # web._assets_backend_helpers
